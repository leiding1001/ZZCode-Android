...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mCameraConfigurationManager != null
            ...
            Camera.Size cameraResolution = mCameraConfigurationManager.getCameraResolution();
            // 取出来的cameraResolution高宽值与屏幕的高宽顺序是相反的
            int cameraPreviewWidth = cameraResolution.height;
            int cameraPreviewHeight = cameraResolution.width;
