...
public class ProcessDataTask extends AsyncTask<Void, Void, QrcodeResult> {
    ...
    @Override
    protected QrcodeResult doInBackground(Void... params) {
    ...
    public interface Delegate {
        QrcodeResult processData(byte[] data, int width, int height, boolean isRetry);
    }
}
